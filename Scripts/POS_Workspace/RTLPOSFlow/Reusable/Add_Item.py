...
def add_items_to_basket(win, banner, TC_ID, Iteration) -> bool:
...
#     return False
    ...
    if global_instance.article_name_list=="" and global_instance.article_price_list=="":
        return False, "No articles were detected in the basket. can't proceed with transaction without articles."
    ...
    # )
    return True, "Items added to basket and details updated in CSV successfully."