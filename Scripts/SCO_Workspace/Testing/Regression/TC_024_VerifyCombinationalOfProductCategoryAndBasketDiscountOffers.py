"""
TC_024_VerifyCombinationalOfProductCategoryAndBasketDiscountOffers.py
---------------------------------------------------------------------
...
TC_ID  = "TC_024_VerifyCombinationalOfProductCategoryAndBasketDiscountOffers"
BANNER = "SM"
...
try:
    ...
    logger.log("  TC_024 — Verify Combinational Of Product Category And Basket Discount Offers", status="info")
    logger.log("=" * 70, status="info")
    ...
    logger.log(f"❌ TC_024 unexpected error: {e}", status="fail")
    logger.take_screenshot("TC_024_Unexpected_Error")
