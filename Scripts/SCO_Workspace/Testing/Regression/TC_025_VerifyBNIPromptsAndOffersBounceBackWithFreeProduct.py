...
------------------------------------------------------------
TC_025 — Verify B N I Prompts And Offers Bounce Back With Free Product
...
try:
    ...
    logger.log("  TC_025 — Verify B N I Prompts And Offers Bounce Back With Free Product", status="info")
    logger.log("=" * 70, status="info")
