...
run_all_Sanity.py
-------------------
Runs every TC_*.py test script in this (Sanity) suite folder, one after
...
Results:
    ...
    Batch summary           : Scripts\\SCO_Workspace\\Results\\BatchSummary_Sanity_<timestamp>.txt
"""
...
if __name__ == "__main__":
    run_suite(current_file_path.parent, "Sanity")
