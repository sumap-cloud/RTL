...
run_all_NZ.py
--------------
Runs every TC_*.py test script in this (NZ) suite folder, one after another,
...
Results:
    ...
    Batch summary           : Scripts\\SCO_Workspace\\Results\\BatchSummary_NZ_<timestamp>.txt
"""
...
if __name__ == "__main__":
    run_suite(current_file_path.parent, "NZ")
