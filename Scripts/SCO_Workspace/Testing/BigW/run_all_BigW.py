...
run_all_BigW.py
-----------------
Runs every TC_*.py test script in this (BigW) suite folder, one after
...
Results:
    ...
    Batch summary           : Scripts\\SCO_Workspace\\Results\\BatchSummary_BigW_<timestamp>.txt
"""
...
if __name__ == "__main__":
    run_suite(current_file_path.parent, "BigW")
