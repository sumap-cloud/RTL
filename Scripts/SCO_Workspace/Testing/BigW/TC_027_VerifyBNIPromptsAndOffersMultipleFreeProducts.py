"""
TC_027_VerifyBNIPromptsAndOffersMultipleFreeProducts.py
-------------------------------------------------------
...
TC_ID  = "TC_027_VerifyBNIPromptsAndOffersMultipleFreeProducts"
BANNER = "SM"
...
try:
    ...
    logger.log("  TC_027 — Verify B N I Prompts And Offers Multiple Free Products", status="info")
    logger.log("=" * 70, status="info")
    ...
    for ean in [EAN_IT1, EAN_IT2, EAN_IT3]:
        if ean:
    ...
    logger.log(f"❌ TC_027 unexpected error: {e}", status="fail")
    logger.take_screenshot("TC_027_Unexpected_Error")
