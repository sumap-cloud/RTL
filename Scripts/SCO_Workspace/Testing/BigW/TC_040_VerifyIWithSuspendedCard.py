"""
TC_040_VerifyIWithSuspendedCard.py
----------------------------------
...
TC_ID  = "TC_040_VerifyIWithSuspendedCard"
BANNER = "SM"
...
try:
    ...
    logger.log("  TC_040 — Verify I With Suspended Card", status="info")
    logger.log("=" * 70, status="info")
    ...
    logger.log(f"❌ TC_040 unexpected error: {e}", status="fail")
    logger.take_screenshot("TC_040_Unexpected_Error")
